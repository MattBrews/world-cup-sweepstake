...
export class FifaCalendarProvider extends DataService {
  get name() { return 'fifa-calendar'; }
  ...
  async syncApiMatchIds() {
    const db = getDb();
    const results = await this.fetchCalendar();
...
export { TEAM_NAME_MAP, fifaName, namesMatch, ourName };
