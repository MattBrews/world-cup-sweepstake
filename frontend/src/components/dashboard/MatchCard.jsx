...
export default function MatchCard({ fixture, homeTeam, awayTeam, participants, teams, allFixtures, compact, onClick }) {
    ...
    >
      ...
      {!compact && (
        <div style={{ fontSize: 11, color: 'var(--color-text-muted)', marginBottom: 6 }}>
          {isLive ? (
            <div>🔴 LIVE{fixture.current_minute_display ? ` ${fixture.current_minute_display}'` : fixture.current_minute != null ? ` ${fixture.current_minute}'` : ''}</div>
          ) : isAwaiting ? (
