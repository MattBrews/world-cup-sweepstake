...
import { getDashboard, getParticipants, addParticipant, removeParticipant, getSession } from '../api/client';
    ...
    <>
      ...
      <div style={{ marginLeft: 240, maxWidth: 960, padding: '24px 16px' }}>
        <div style={{ marginBottom: 24 }}>
          ...
          <div style={{ fontSize: 12, color: 'var(--color-text-muted)' }}>Participants</div>
        </div>
